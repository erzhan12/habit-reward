...
class Command(BaseCommand):
    """Delete expired WebLoginRequest records."""

    help = "Delete web login requests that have passed their expiry time"
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            logger.info(
                "cleanup_expired_logins completed: deleted %d records",
                deleted_count,
            )
