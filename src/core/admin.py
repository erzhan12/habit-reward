...
class UserAdmin(BaseUserAdmin):
    ...
    list_display = ['username', 'telegram_id', 'name', 'is_active', 'language', 'timezone', 'theme', 'is_staff', 'date_joined']
    list_filter = ['is_active', 'is_staff', 'is_superuser', 'language', 'timezone', 'theme', 'date_joined']
    ...
    fieldsets = (
        ...
        ('Telegram Information', {
            'fields': ('telegram_id', 'name', 'language', 'timezone', 'theme')
        }),
        ('Personal info', {
...
class RewardAdmin(admin.ModelAdmin):
    ...
    list_display = ['name', 'user', 'weight', 'pieces_required', 'piece_value', 'max_daily_claims', 'is_recurring', 'active', 'created_at']
    list_filter = ['active', 'is_recurring', 'created_at', 'user']
    ...
    fieldsets = (
        ('Reward Information', {
            'fields': ('user', 'name', 'weight', 'pieces_required', 'piece_value', 'is_recurring', 'active'),
