...
async def habit_exempt_days_text_received(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    try:
        ...
        if not u…9170 tokens truncated…t_message_text(success_message, parse_mode="HTML")
        ...
        _schedule_message_delete(success_msg_obj, telegram_id, "habit edit success", context)
...
async def cancel_edit_habit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    _schedule_message_delete(cancel_msg_obj, telegram_id, "edit habit cancellation", context)
...
async def habit_remove_confirmed(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if callback_data == "confirm_no":
        ...
        _schedule_message_delete(cancel_msg_obj, telegram_id, "habit removal cancellation", context)
...
async def cancel_remove_habit(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    _schedule_message_delete(cancel_msg_obj, telegram_id, "remove habit cancellation", context)
