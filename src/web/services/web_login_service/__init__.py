...
Package structure::
    ...
    web_login_service/
        ...
        token_collision.py       — Token collision retry with cache alias
...
from .token_collision import (  # noqa: F401
    create_login_request_with_retry,
)
...
class WebLoginService:
    ...
    # Delegate to the extracted module function.  Kept as a staticmethod
    # so callers (e.g. _process_login_request) don't need to change.
    _create_login_request_with_retry = staticmethod(create_login_request_with_retry)
