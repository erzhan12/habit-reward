...
> **Note (2026-02):** The streak multiplier system referenced in this plan has been replaced by a subtractive probability system where habit weights and streaks reduce the no-reward probability. See migration 0026 and `src/services/reward_service.py`.
