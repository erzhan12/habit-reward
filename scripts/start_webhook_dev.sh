...
echo ""
print_msg $YELLOW "    make ngrok"
print_msg $BLUE "    (or: ngrok http 8000)"
echo ""
...
echo ""
print_msg $GREEN "STEP 2: Start combined ASGI server (Django + FastAPI)"
print_msg $BLUE "----------------------------------------"
echo "Open ANOTHER NEW terminal window and run:"
echo ""
print_msg $YELLOW "    cd $PROJECT_ROOT"
print_msg $YELLOW "    make api"
print_msg $BLUE "    (This runs uvicorn for the combined app: /webhook/telegram + /v1/* + /health)"
echo ""
...
echo "Open ANOTHER NEW terminal window and run:"
echo ""
print_msg $YELLOW "    make frontend"
print_msg $BLUE "    (or: cd frontend && npm run dev)"
echo ""
